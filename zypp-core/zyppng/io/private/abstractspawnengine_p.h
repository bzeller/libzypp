...
namespace zyppng {
  ...
  public:
    ...
    StderrDisposition stdErrDisposition() const;
    void setStdErrDisposition(const StderrDisposition &stdErrDisposition);
  ...
  protected:
    ...
    /** Stdin, Stdout, Stderr all unbuffered **/
    int _fileset[3] = { -1, -1, -1 };

    StderrDisposition _stdErrDisposition;
  };
