...
namespace zyppng {
  ...
  AbstractSpawnEngine::StderrDisposition AbstractSpawnEngine::stdErrDisposition() const
  {
    return _stdErrDisposition;
  }

  void AbstractSpawnEngine::setStdErrDisposition(const StderrDisposition &stdErrDisposition)
  {
    _stdErrDisposition = stdErrDisposition;
  }
  ...
  int AbstractSpawnEngine::stdoutFd() const
  {
    return _fileset[1];
  }

  int AbstractSpawnEngine::stdinFd() const
  {
    return _fileset[0];
  }

  int AbstractSpawnEngine::stderrFd() const
  {
    return _fileset[2];
  }
